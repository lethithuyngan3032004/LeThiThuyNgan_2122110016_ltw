            ...
            <div class="card">
               ...
               <div class="row">
                  <div div class="col-md-6">
                     <a href="index.php?option=order" class="btn btn-sm btn-primary">Tất cả</a>
                     <a href="index.php?option=order&cat=trash" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i> Thùng rác</a>
                  </div>
               </div>
               </div>
