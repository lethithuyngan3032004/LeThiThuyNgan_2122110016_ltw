                        ...
                        <tr class="datarow">
                           ...
                           <td>
                              ...
                              <div class="function_style">                                                                     
                                       <a href="index.php?option=slider&cat=restore&id=<?=$item->id; ?>" class="btn btn-info btn-xs">
                                       <i class="fas fa-undo"></i> Khôi Phục 
                                       </a>
                                       <a href="index.php?option=slider&cat=destroy&id=<?=$item->id; ?>" class="btn btn-danger btn-xs">
