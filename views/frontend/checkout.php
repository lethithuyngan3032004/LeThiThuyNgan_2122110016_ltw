...
if(isset($_POST['XATNHAN']) && count($listcart)>0) {
   $order= new Order();
               ...
               <?php if(isset($_SESSION["iscustom"])):?>
                  ...
                  <div class="thanhtoan mb-4">
                     ...
                     <div class="p-4 border bankinfo">
                        ...
                        <p>STK: 0868052187</p>
                        <p>Chủ tài khoản: Lê Thị Thúy Ngân</p>
                     </div>
                  </div>
                  <div class="text-end">
                     <button type="submit" name="XATNHAN" class="btn btn-main px-4">XÁC NHẬN</button>
                  </div>
               <?php endif;?>
              </form>
            ...
            <div class="col-md-6">
               ...
               <table class="table table-borderless">
                  ...
                  <tbody>
                     ...
                     <?php foreach($listcart as $item):?>
                        <?php $money_item=$item['qty']*$item['price'];?>
                        <tr>
                           <td class="text-center align-middle"><?=$stt;?></td>
                           <td>
                           <img class="img-fluid" src="public/images/product/<?=$item['image'];?> "alt="<?=$cart['image'];?>">
                           </td>
               ...
               <table class="table table-borderless">
                  ...
                  <tr>
                     ...
                     <td class="text-end"><?=number_format(40000);?></td>
                  </tr>
                  <tr>
                     <th>Giảm giá</th>
                     <td class="text-end"><?=number_format(Cart::cartTotal()*0.03);?></td>
                  </tr>
                  <tr>
                     <th>Tổng cộng</th>
                     <td class="text-end"><?=number_format(Cart::cartTotal()+40000-Cart::cartTotal()*0.03);?></td>
                  </tr>
               </table>
            </div>
         </div>
