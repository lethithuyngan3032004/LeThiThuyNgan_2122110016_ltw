...
<?php require_once "views/frontend/header.php"?>
   ...
   <section class="hdl-maincontent py-2">
      <form action="register.php" method="post" name="registercustomer">
         <div class="container">
                  ...
                  <script>
                     function changeGender() {
                        ...
                        if (elementGender == true) {
                           document.querySelector("#labelgender").innerphp = "Nam";
                        }
                        else {
                           document.querySelector("#labelgender").innerphp = "Nữ";
                        }
                     }
                  </script>
               </div>
