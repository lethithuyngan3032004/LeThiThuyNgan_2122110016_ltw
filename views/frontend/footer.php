<section class="hdl-footer pb-4">
      <div class="container">
         <div class="row">
            <div class="col-md-4 pt-4">
               ...
               <p class="pt-1">
                  ThuyNganShop là hệ thống bán sĩ và lẽ thời trang nam, nữ, trẻ em và quần áo thể thao,
               ...
               <p class="pt-1">
                  Điện thoại: 0868052187(call, zalo) - Email: Lethithuyngan@gmail.com
               </p>
   ...
   <section class="dhl-copyright bg-dark py-3">
      <div class="container text-center text-white">
         Thiết kế bởi: Lê Thị Thúy Ngân - Phone: 0868052187
      </div>
   </section>
</body>
